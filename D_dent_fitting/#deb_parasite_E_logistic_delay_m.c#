...
void derivs (int *neq, double *t, double *y, double *ydot) {
  ...
  ydot[3] = eP*aP*E*Pi*(1-(Pi+Pm)/kP/W) - exp(-m*tau)*eP*aP*ytau[1]*ytau[3]*(1-(ytau[3]+ytau[4])/kP/ytau[2]) - m*Pi;
  ydot[4] = exp(-m*tau)*eP*aP*ytau[1]*ytau[3]*(1-(ytau[3]+ytau[4])/kP/ytau[2]);
}
