...
if (is.loaded("tm_deb_parasite_3v2.so")) dyn.unload("tm_deb_parasite_3v2.so")
system("rm tm_deb_parasite_3v2.so")
system("rm tm_deb_parasite_3v2.o")
system("R CMD SHLIB tm_deb_parasite_3v2.c")
dyn.load("tm_deb_parasite_3v2.so")
