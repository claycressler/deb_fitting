...
## This model
model <- "deb_parasite_W_TypeI_delay_m"
...
estpars <- c(km=0.073, aP=1e-8, eP=1e10, m=0.01, tau=10, Pobs=500)
...
box <- cbind(lower=c(km=0.073, aP=1e-12, eP=1e6, m=1e-4, tau=5, Pobs=10),
             upper=c(km=0.073, aP=1e-6, eP=1e12, m=1e-1, tau=15, Pobs=1000))
...
## initial guesses at the estimated parameter values
box <- cbind(lower=c(rho=0.152, aP=1e-12, eP=1e6, m=1e-4, tau=5, Pobs=10),
             upper=c(rho=0.152, aP=1e-6, eP=1e12, m=1e-1, tau=15, Pobs=1000))
sobolDesign(lower=box[,'lower'],
            upper=box[,'upper'],
            nseq=600000) %>%
                apply(., 1, as.list) %>%
...
## initial guesses at the estimated parameter values
box <- cbind(lower=c(rho=0.152, km=0.073, aP=1e-12, eP=1e6, m=1e-4, tau=5, Pobs=10),
             upper=c(rho=0.152, km=0.073, aP=1e-6, eP=1e12, m=1e-1, tau=15, Pobs=1000))
sobolDesign(lower=box[,'lower'],
            upper=box[,'upper'],
            nseq=600000) %>%
                apply(., 1, as.list) %>%
