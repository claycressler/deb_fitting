...
void VB5_par_trans (double *__pt, double *__p, int *__parindex)
{
...
void VB5_par_untrans (double *__pt, double *__p, int *__parindex)
{
...
void VB5_rmeasure (double *__y, double *__x, double *__p, int *__obsindex, int *__stateindex, int *__parindex, int *__covindex, int __ncovars, double *__covars, double t)
{
  Lobs = rnorm(L,L_sd);  
}
...
void VB5_skelfn (double *__f, double *__x, double *__p, int *__stateindex, int *__parindex, int *__covindex, int __ncovars, double *__covars, double t)
{
 double rate; //transition rates
  rate = r*(Linf-L);
  DL += rate;
